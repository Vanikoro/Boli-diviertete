...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "juegos tradicionales para eventos empresariales",
    "diversión para eventos en Bogotá",
    "alquiler de juegos para niños",
    "juegos al aire libre en Bogotá",
    "eventos sociales con juegos tradicionales",
    "Boli-Diviértete alquiler de juegos",
    "alquiler boliranas bogota", 
    "alquiler boliranas bogota y sabana",
    "alquiler tejos bogota",
    "alquiler juegos tradicionales bogota",
    "alquiler juegos para eventos bogota",
    "alquiler juegos para fiestas bogota",
    "alquiler juegos para niños bogota",
    "alquiler juegos al aire libre bogota",
    "eventos sociales con juegos tradicionales bogota",
    "Boli-Diviértete alquiler de juegos bogota",
  ],
  icons: {
    icon: [
